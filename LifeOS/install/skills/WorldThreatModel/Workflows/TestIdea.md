...
- World models must exist at `$LIFEOS_DIR/MEMORY/RESEARCH/WorldModels/`
...
```
Check $LIFEOS_DIR/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `$LIFEOS_DIR/MEMORY/RESEARCH/WorldModels/`.
