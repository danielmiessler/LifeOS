# ═══════════════════════════════════════════════════════════
#  PAI Installer v3.0 — Bootstrap Script (Windows PowerShell)
...
Write-Host ""
Write-Host "                                          ${SEP}  ${GRAY}`"${RESET}${LIGHT_BLUE}Kai here, ready to go${RESET}${GRAY}...`"${RESET}"
Write-Host "                                          ${SEP}  ${BAR}"
Write-Host "                                          ${SEP}  ${NAVY}*${RESET}  ${GRAY}PAI${RESET}       ${SILVER}v3.0${RESET}"
Write-Host "                                          ${SEP}  ${NAVY}*${RESET}  ${GRAY}Algo${RESET}      ${SILVER}v1.4.0${RESET}"
Write-Host "                                          ${SEP}  ${LIGHT_BLUE}*${RESET}  ${GRAY}Installer${RESET} ${SILVER}v3.0${RESET}"
Write-Host "                                          ${SEP}  ${BAR}"
Write-Host "                                          ${SEP}"
Write-Host "                                          ${SEP}  ${YELLOW}`u{26A0}  Alpha -- rough edges expected${RESET}"
Write-Host ""
