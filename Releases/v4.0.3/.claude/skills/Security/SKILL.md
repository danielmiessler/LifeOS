...
Route security assessment and intelligence requests to the appropriate sub-skill.

| Request Pattern | Route To |
|---|---|
| Recon, port scan, subdomain, DNS, WHOIS, ASN | `Recon/SKILL.md` |
| Web assessment, OWASP, pentest, ffuf, threat modeling | `WebAssessment/SKILL.md` |
| Prompt injection, jailbreak, LLM security, guardrail bypass | `PromptInjection/SKILL.md` |
| Security news, breaches, tldrsec, security research | `SECUpdates/SKILL.md` |
| Annual reports, threat landscape, vendor reports | `AnnualReports/SKILL.md` |
