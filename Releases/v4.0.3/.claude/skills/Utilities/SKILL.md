---
name: utilities
description: "Developer utilities hub — routes to sub-skills for CLI generation, skill scaffolding, agent delegation, system upgrades, evals, document processing, parsing, audio editing, Fabric patterns, Cloudflare, browser automation, meta-prompting, and aphorisms. USE WHEN create CLI, build CLI, create skill, scaffold skill, delegate, agent teams, upgrade system, PAI upgrade, eval, benchmark, document, PDF, DOCX, parse, extract, clean audio, fabric pattern, Cloudflare deploy, browser automate, prompt engineering, aphorism, quote."
---
