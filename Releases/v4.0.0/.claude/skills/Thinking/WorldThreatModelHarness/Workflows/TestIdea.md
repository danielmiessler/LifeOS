...
- World models must exist at `$PAI_DIR/MEMORY/RESEARCH/WorldModels/`
...
```
Check $PAI_DIR/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `$PAI_DIR/MEMORY/RESEARCH/WorldModels/`.
