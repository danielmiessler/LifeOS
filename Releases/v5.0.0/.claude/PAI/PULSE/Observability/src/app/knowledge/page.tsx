    ...
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      {isFreshInstall && (
        <EmptyStateGuide
          ...
          description="Curated notes on people, companies, ideas, and research — the graph of what you've learned. Notes live under $PAI_DIR/MEMORY/KNOWLEDGE/People|Companies|Ideas|Research/."
