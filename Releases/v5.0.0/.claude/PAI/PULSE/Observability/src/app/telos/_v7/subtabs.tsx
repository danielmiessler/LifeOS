...
const SPARK_SEEDS = {
  ...
  money:         [36,39,42,44,47,50,52,55,58,60,61,62],
  freedom:       [30,31,34,36,38,40,42,43,45,46,47,48],
  creative:      [48,49,51,53,54,57,58,59,60,61,61,62],
  relationships: [82,81,80,79,78,78,77,77,77,78,77,77],
} as const;
