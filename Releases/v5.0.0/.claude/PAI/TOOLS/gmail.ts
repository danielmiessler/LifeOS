...
import { expandPath, paiPath } from '../lib/paths';

const CREDS_PATH = process.env.GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE
  ? expandPath(process.env.GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE)
