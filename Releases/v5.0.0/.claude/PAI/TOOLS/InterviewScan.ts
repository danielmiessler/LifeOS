...
const REGISTRY: Array<Omit<Target, "content_length" | "tbd_count" | "seed_markers" | "empty_sections" | "required_fields_missing" | "completeness_score" | "priority" | "review_mode" | "why_incomplete">> = [
  ...
  { phase: 3, path: join(USER_DIR, "Books.md"), name: "BOOKS", category: "preference", leverage: 5,
  ...
  { phase: 3, path: join(USER_DIR, "Authors.md"), name: "AUTHORS", category: "preference", leverage: 5,
  ...
  { phase: 3, path: join(USER_DIR, "Music.md"), name: "MUSIC", category: "preference", leverage: 4,
  ...
  { phase: 3, path: join(USER_DIR, "Movies.md"), name: "MOVIES", category: "preference", leverage: 3,
  ...
  { phase: 3, path: join(USER_DIR, "Restaurants.md"), name: "RESTAURANTS", category: "preference", leverage: 4,
    prompts: ["Favorites in your city — your go-to list?",
              "Any restaurants on the blocklist (never recommend)?",
              "Special-occasion places?"] },
  { phase: 3, path: join(USER_DIR, "Food.md"), name: "FOOD", category: "preference", leverage: 4,
    prompts: ["Top 3-5 cuisines you eat weekly happily?",
              "Cuisines avoided?",
              "Spice tolerance, dietary posture?",
              "Dishes you love to make?"] },
  { phase: 3, path: join(USER_DIR, "Learning.md"), name: "LEARNING", category: "preference", leverage: 4,
    prompts: ["What skills or topics do you want to actively learn?",
              "Any dormant-but-interested topics?"] },
  { phase: 3, path: join(USER_DIR, "Meetups.md"), name: "MEETUPS", category: "preference", leverage: 3,
    prompts: ["What meetup topics interest you?",
              "Preferred event size and price ceiling?",
              "Any specific groups you already like locally?"] },
  { phase: 3, path: join(USER_DIR, "Civic.md"), name: "CIVIC", category: "preference", leverage: 2,
    prompts: ["What local civic topics do you want flagged?",
              "City council topics to always watch?",
