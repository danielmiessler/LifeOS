...
CLAUDE_PLUGINS_DIR="$CLAUDE_CONFIG_DIR/plugins"
...
PAI_KNOWLEDGE_DIR="$PAI_DIR/MEMORY/KNOWLEDGE"
PAI_WORK_DIR="$PAI_DIR/MEMORY/WORK"
PAI_OBSERVABILITY_DIR="$PAI_DIR/MEMORY/OBSERVABILITY"
PAI_USER_DIR="$PAI_DIR/USER"
PAI_TOOLS_DIR="$PAI_DIR/TOOLS"
PAI_ALGORITHM_DIR="$PAI_DIR/ALGORITHM"
PAI_DOCS_DIR="$PAI_DIR/DOCUMENTATION"

export CLAUDE_CONFIG_DIR PAI_DIR \
       CLAUDE_HOOKS_DIR CLAUDE_SKILLS_DIR CLAUDE_AGENTS_DIR \
       CLAUDE_COMMANDS_DIR CLAUDE_PLUGINS_DIR \
       CLAUDE_SETTINGS_FILE CLAUDE_ENV_FILE \
       PAI_MEMORY_DIR PAI_STATE_DIR PAI_LEARNING_DIR \
       PAI_KNOWLEDGE_DIR PAI_WORK_DIR PAI_OBSERVABILITY_DIR \
       PAI_USER_DIR PAI_TOOLS_DIR PAI_ALGORITHM_DIR PAI_DOCS_DIR \
