...
description: "Ethical OSINT investigation framework. Spawns parallel research agents across public records, social media, and web sources. USE WHEN you need to conduct ethical open-source intelligence gathering — people search, identity verification, social media footprint analysis, public records lookup, or username enumeration across platforms. NOT FOR stalking, harassment, illegal data access, or bypassing paywalls/privacy controls."
version: 5.0.0
author: PAI v5.0 → Hermes Port
license: MIT
metadata:
  hermes:
    tags: [pai, osint, investigation, research]
    related_skills: []
